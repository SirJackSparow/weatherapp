class WeatherAppResources {
  ...
  static String jsonExtended = "/json";

  static String splashCloud = "$assets$imagesExtended/splash_cloud.svg";
  static String cityPlaceHolder =
      "$assets$imagesExtended/modern_city_place_holder.png";
  ...
  static String dailyForecastMock =
      '$assets$jsonExtended/mockdailyforecast.json';
}
